    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="cta-buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">Masuk Sekarang</a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary">Daftar Gratis</a>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\LENOVO\web-makanan\resources\views/welcome.blade.php ENDPATH**/ ?>
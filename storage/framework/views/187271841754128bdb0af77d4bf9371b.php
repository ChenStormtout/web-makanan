    ...
    <div class="page-content-wrapper">
        <div class="page-header">
            ...
            <div class="cart-button-wrapper">
                ...
                <a href="<?php echo e(route('customer.cart')); ?>" class="cart-button">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <form method="POST" action="<?php echo e(route('customer.cart.add', $product->id)); ?>" class="add-to-cart-form">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\LENOVO\web-makanan\resources\views/customer/menu.blade.php ENDPATH**/ ?>
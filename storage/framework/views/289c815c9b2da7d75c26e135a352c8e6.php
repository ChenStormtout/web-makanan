                ...
                <table class="custom-table">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="table-row <?php echo e($loop->odd ? 'odd-row' : 'even-row'); ?>">
                                <td><?php echo e($loop->iteration); ?></td>
                                <td class="order-code"><?php echo e($order->order_code); ?></td>
                                <td>
                                ...
                                <td class="payment-method-cell"><?php echo e($order->payment_method); ?></td>
                                <td class="created-at-cell"><?php echo e($order->created_at->format('d M Y H:i')); ?></td>
                            </tr>
...
</script><?php /**PATH C:\Users\LENOVO\web-makanan\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>
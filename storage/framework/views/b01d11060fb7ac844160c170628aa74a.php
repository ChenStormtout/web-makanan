...
<head>
    ...
    <title><?php echo e(auth()->user()->role === 'admin' ? 'Admin Dashboard - SeblakMania' : 'Dashboard Pelanggan - SeblakMania'); ?></title>
...
<div class="app-container">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <h2 class="nav-title">
                <?php echo e(auth()->user()->role === 'admin' ? 'Admin Panel' : 'Menu Pelanggan'); ?>

            </h2>
            <div class="space-y-2"> 
                <?php if(auth()->user()->role === 'admin'): ?>
                    <a href="<?php echo e(route('admin.products.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.products.*') ? 'active-link' : ''); ?>">
                        <i data-lucide="package"></i>
                        <span>Kelola Produk</span>
                    </a>
                    <a href="<?php echo e(route('admin.orders.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active-link' : ''); ?>">
                        <i data-lucide="shopping-cart"></i>
                        <span>Kelola Pesanan</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('admin.reports.*') ? 'active-link' : ''); ?>">
                        <i data-lucide="bar-chart-2"></i>
                        <span>Laporan Penjualan</span>
                    </a>
                     <a href="<?php echo e(route('profile.edit')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('profile.edit') ? 'active-link' : ''); ?>">
                        <i data-lucide="user"></i>
                         <span>Profil Saya</span>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('customer.menu')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('customer.menu') ? 'active-link' : ''); ?>">
                        <i data-lucide="utensils"></i>
                        <span>Menu Makanan</span>
                    </a>
                    <a href="<?php echo e(route('customer.orders')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('customer.orders') ? 'active-link' : ''); ?>">
                        <i data-lucide="clipboard-list"></i>
                        <span>Pesanan Saya</span>
                    </a>
                    <a href="<?php echo e(route('customer.history.index')); ?>"
                       class="nav-link <?php echo e(request()->routeIs('customer.history.index') ? 'active-link' : ''); ?>">
            ...
            <div class="flex items-center space-x-4">
                <div class="profile-dropdown">
                    <button class="profile-button">
                        <img src="https://placehold.co/40x40/<?php echo e(str_replace('#','',substr(auth()->user()->name, 0, 1) === 'A' ? 'FF7043' : 'FFA726')); ?>/white?text=<?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?>" 
                             alt="Avatar" 
                             class="profile-avatar">
                        <span class="profile-name hidden md:block"><?php echo e(auth()->user()->name); ?></span>
                    </button>
                </div>
            </div>
        </header>
...
</html><?php /**PATH C:\Users\LENOVO\web-makanan\resources\views/layouts/app.blade.php ENDPATH**/ ?>
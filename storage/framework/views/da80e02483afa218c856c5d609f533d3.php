    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="welcome-section">
                <h1>
                    Selamat Datang, <span class="username"><?php echo e(Auth::user()->name); ?></span>!
                </h1>
                <p>
                ...
                <div class="stat-card pending">
                    <div class="flex">
                        <div>
                            ...
                            <p class="value"><?php echo e($pendingOrdersCount ?? 'N/A'); ?></p>
                        </div>
                        <div class="stat-icon-wrapper">
                            <i data-lucide="truck" class="w-6 h-6"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(route('customer.orders')); ?>" class="view-link">
                ...
                <div class="stat-card completed">
                    <div class="flex">
                        <div>
                            ...
                            <p class="value"><?php echo e($completedOrdersCount ?? 'N/A'); ?></p>
                        </div>
                        <div class="stat-icon-wrapper">
                            <i data-lucide="check-circle-2" class="w-6 h-6"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(route('customer.history.index')); ?>" class="view-link">
            ...
            <div class="product-section foods">
                ...
                <div class="products-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $makanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="product-card">
                            <div class="product-card-image">
                                <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://placehold.co/400x400/f8f9fa/6c757d?text=Food'); ?>"
                            ...
                            <div class="product-card-content">
                                ...
                                <p class="description">
                                    <?php echo e($product->description ?? 'Hidangan lezat dengan bahan berkualitas.'); ?>
            ...
            <div class="product-section drinks">
                ...
                <div class="products-grid">
                    <?php $__empty_1 = true; $__currentLoopData = $minuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="product-card">
                            <div class="product-card-image">
                                <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://placehold.co/400x400/f8f9fa/6c757d?text=Drink'); ?>"
                                     alt="<?php echo e($product->name); ?>"
                                     loading="lazy">
                            </div>
                            ...
                            <div class="product-card-content">
                                <h3><?php echo e($product->name); ?></h3>
                                <p class="description">
                                    <?php echo e($product->description ?? 'Minuman segar untuk menemani hari Anda.'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\LENOVO\web-makanan\resources\views/dashboard/customer.blade.php ENDPATH**/ ?>
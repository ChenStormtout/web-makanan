            ...
            <a href="{{ route('admin.products.index') }}" class="stat-card-link">
                <div class="stat-card-content">
                    ...
                    <div class="stat-value-container">
                        ...
                        <p class="stat-value">{{ $totalProduk ?? 0 }}</p> {{-- Add null coalescing for safety --}}
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('admin.orders.index') }}" class="stat-card-link">
                <div class="stat-card-content">
                    ...
                    <div class="stat-value-container">
                        ...
                        <p class="stat-value">{{ $totalPesanan ?? 0 }}</p> {{-- Add null coalescing for safety --}}
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('admin.reports.index') }}" class="stat-card-link">
                <div class="stat-card-content">
                    ...
                    <div class="stat-value-container">
                        ...
                        <p class="stat-value">Rp {{ number_format($totalPenjualan ?? 0, 0, ',', '.') }}</p> {{-- Add null coalescing for safety --}}
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="recent-activity-section">
            ...
            <div class="activity-card">
                <ul class="activity-list">
                    {{-- Loop data aktivitas terbaru dari backend --}}
                    {{-- Contoh data dummy, ganti dengan looping data sebenarnya dari controller Anda --}}
                    <li class="activity-list-item">
                        <i data-lucide="receipt" class="activity-icon new-order"></i>
                        <div class="activity-text-container">
                            <p class="activity-description">Pesanan baru diterima dari <span class="font-semibold">{{ 'Customer A' }}</span></p>
                            <p class="activity-timestamp">{{ now()->diffForHumans() }}</p>
                        </div>
                    </li>
                    <li class="activity-list-item">
                        <i data-lucide="package-plus" class="activity-icon product-update"></i>
                        <div class="activity-text-container">
                            <p class="activity-description">Produk "<span class="font-semibold">{{ 'Seblak Spesial' }}</span>" berhasil diperbarui</p>
                            <p class="activity-timestamp">{{ now()->subMinutes(10)->diffForHumans() }}</p>
                        </div>
                    </li>
                    <li class="activity-list-item">
                        <i data-lucide="user-plus" class="activity-icon new-user"></i>
                        <div class="activity-text-container">
                            <p class="activity-description">Pengguna baru "<span class="font-semibold">{{ 'Budi' }}</span>" telah mendaftar</p>
                            <p class="activity-timestamp">{{ now()->subHour()->diffForHumans() }}</p>
                        </div>
                    </li>
                    <li class="activity-list-item">
                        ...
                        <div class="activity-text-container">
                            ...
                            <p class="activity-timestamp">{{ now()->subHours(2)->diffForHumans() }}</p>
                        </div>
                    </li>
                </ul>
            </div>

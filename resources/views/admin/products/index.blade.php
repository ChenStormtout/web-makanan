<x-app-layout>
    ...
    <div class="page-content-wrapper">
        <div class="header-section">
            ...
            <a href="{{ route('admin.products.create') }}" class="add-product-button">
                        ...
                        @forelse($products as $product)
                            <tr class="{{ $loop->odd ? 'odd-row' : 'even-row' }}">
                                <td class="product-name-cell">
                                    ...
                                    <div class="text-xs mt-1">{{ Str::limit($product->description, 50) }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="action-buttons-group">
                                        <a href="{{ route('admin.products.edit', $product) }}" class="action-button-icon edit">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value-container">
                        ...
                        <p class="stat-value">Rp {{ number_format($products->avg('price'), 0, ',', '.') }}</p>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value-container">
                        ...
                        <p class="stat-value">{{ $products->pluck('category_id')->unique()->count() }}</p>
                    </div>
                </div>
            </div>
        @endif
        
        {{-- Script untuk memastikan Lucide Icons di-render setelah konten dimuat --}}
        <script>
            lucide.createIcons();
        </script>
    </div>
